                             ...
                             void       *texit)
{
    ...
    //frame->ra      = (rt_ubase_t)texit; //mod
	frame->ra      = (rt_ubase_t)tentry; // my code
...
void handle_trap_software(void);

extern int timer_num1;
