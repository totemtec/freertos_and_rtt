...
static int verify_int8(int n, const volatile  int8_t* test, const int8_t* verify)
{
  int i;
...
static int verifyshort(int n, const volatile short int* test, const short int* verify)
{
  int i;
  // Unrolled for faster verification
  for (i = 0; i < n/2*2; i+=2)
